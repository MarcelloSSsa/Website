...
<body class="nav-md">
		...
		<div class="main_container">
			...
			<div class="right_col" role="main">
				...
				<div class="col-md-6 col-sm-6 col-xs-12">
							...
							<div class="x_title">
								<h2>
									Fatores que influenciam <small>na compra</small>
								</h2>
                            ...
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2>Fatores que influenciam <small>na compra</small></h2>
                                    <div class="clearfix"></div>
                                </div>
                                <div class="x_content">
                                    <table class="table table-bordered">
                                        <thead>
                                            <tr>
                                                <th>#</th>
                                                <th>Resposta de frotistas (Q1-2016)</th>
                                                <th>Resposta dos concessionários (Q2-2016)</th>
                                                <th>Concessionária marca 'A' (Q1-216)</th>       
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <tr>
	...
	<script>
	var barChartData3 = {
			labels : ["Frotista (Q1-16)", "Concessinários (Q1-16)", "Marca A (Q1-2016)"],
			datasets : [ {
