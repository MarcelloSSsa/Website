...
<body class="nav-md">
		...
		<div class="main_container">
			...
			<div class="right_col" role="main">
				...
				<div class="x_panel">
							<div class="x_title">
								<h2>
									Tecnologias <small>mais mencionadas</small>
								</h2>

								<div class="clearfix"></div>
							</div>
							<div style="width:40 px; height: 30 px;" class="x_content">
				...
				<div class="x_panel">
							...
							<div class="x_content">
								<p>Essas são as principais tecnologias que os clientes buscam, sempre que estão comprando caminhões novos. Dentre elas se destacam o ar condicionado e a transmissão automática/automatizada, que são considerados como ítens indispensáveis em um caminhão novo. </p>
							</div>
						</div>	
				</div>
	...
	<script>
		...
		var barChartData = {
				labels : [ "Ar Condicionado", "Transmissão AT/AMT", "Telemática", "Tecnologia 'X'", "Tecnologia 'Y'", "Outros" ],
				datasets : [ {
