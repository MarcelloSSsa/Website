...
<title>Vendas Médias por Categoria</title>
...
<body class="nav-md">
				...
				<div class="">
					<div class="page-title">
						<div class="title_left">
							<h3>
								Vendas Médias <small>Por Categoria</small>
							</h3>
						</div>
					...
					<div class="col-md-6 col-sm-6 col-xs-12">
						<div class="x_panel">
							<div class="x_title">
								<h2>
									Média de Venda <small>Por Categoria</small>
								</h2>
							...
							<div class="x_content">
								...
								<br />
								<br />
								<p>Média de vendas de caminhões (unidades) por categoria no
									segundo semestre de 2015 (mês 4 a mês 6).</p>
							</div>
						</div>
						</div>
						...
						<div class="col-md-6 col-sm-6 col-xs-12">
							<div class="x_panel">
								...
								<div class="x_content">
									<h4>As vendas médias observadas refletem o cenário no qual
										o volume de veículos comerciais leves liderou dentras as
										pesquisas respondidas, seguido pelos veículos comerciais
										médios e por fim os pesados. Contudo, ressalta-se que a
										diferença entre eles é pequena, e algumas regiões apresentaram
										vendas superiores em outras categorias se comparado com a
										média geral.</h4>
								</div>
							</div>
						</div>
	...
	<script>
		...
		var barChartData = {
				labels : [ "Leves (0–10 ton)", "Médios (10-15 ton)", "Pesados (+ 15 ton)"],
				datasets : [ {
