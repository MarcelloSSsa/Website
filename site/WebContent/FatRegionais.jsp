...
<body class="nav-md">
			...
			<div class="right_col" role="main">
				<div class="">
					<div class="page-title">
						<div class="title_left">
							<h3>
								Fatores de maior influência na hora da compra de veículos <small></small>
							</h3>
						</div>
					</div>
				</div>
				...
				<div class="row">
                            ...
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            <tr>
                                                <th scope="row">Pré compra por novo regulamento</th>
                                                <td>42</td>
                                                <td>3</td>
                                                <td>2</td>
                                                <td>17</td>
                                            ...
                                            <tr>
                                                <th scope="row">Record de colheita</th>
                                                <td>36</td>
                                                <td>0</td>
                                                <td>0</td>
                                                <td>15</td>
                                            ...
                                            <tr>
                                                <th scope="row">Estratégia de crescimento marca</th>
                                                <td>42</td>
                                                <td>3</td>
                                                <td>2</td>
                                                <td>17</td>
                                            ...
                                            <tr>
                                                <th scope="row">Juros da marca</th>
                                                <td>22</td>
                                                <td>4</td>
                                                <td>3</td>
                                                <td>0</td>
                                            ...
                                            <tr>
                                                <th scope="row">Investimentos em infraestrutura</th>
                                                <td>21</td>
                                                <td>2</td>
                                                <td>5</td>
                                                <td>7</td>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2>Fatores <small>de queda</small></h2>
                                    <div class="clearfix"></div>
                                </div>
                                <div class="x_content">
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            <tr>
                                                <th scope="row">Aumento de interesse (FINAME)</th>
                                                <td>103</td>
                                                <td>4</td>
                                                <td>23</td>
                                                <td>18</td>
                                            ...
                                            <tr>
                                                <th scope="row">Instabilidade política</th>
                                                <td>93</td>
                                                <td>8</td>
                                                <td>23</td>
                                                <td>25</td>
                                            ...
                                            <tr>
                                                <th scope="row">Acesso a crédito</th>
                                                <td>64</td>
                                                <td>8</td>
                                                <td>11</td>
                                                <td>10</td>
                                            ...
                                            <tr>
                                                <th scope="row">Desaceleração econômica</th>
                                                <td>61</td>
                                                <td>7</td>
                                                <td>2</td>
                                                <td>21</td>
	...
	var barChartData1 = {
			labels : ["Preço", "Qualidade e tecnologia", "Rede de concessionária", "Marca", "Preço de revenda"],
			datasets : [ {
	...
	$(document).ready(
			function() {
				new Chart($("#canvas4_bar").get(0).getContext("2d")).Bar(
						barChartData4, {
							tooltipFillColor : "rgba(51, 51, 51, 0.55)",
							responsive : true,
							barDatasetSpacing : 6,
	...
	$(document).ready(
			function() {
				new Chart($("#canvas5_bar").get(0).getContext("2d")).Bar(
						barChartData5, {
							tooltipFillColor : "rgba(51, 51, 51, 0.55)",
							responsive : true,
							barDatasetSpacing : 6,
