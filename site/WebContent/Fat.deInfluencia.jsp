...
<title>Fatores de Influência</title>
...
<body class="nav-md">
				...
				<div class="">
					<div class="page-title">
						<div class="title_left">
							<h3>
								Fatores <small>de Influência</small>
							</h3>
						</div>
					...
					<div class="row">
						<div class="x_panel">
							<div class="x_title">
								<h2>
									Fatores de mudança<small> nas vendas</small>
								</h2>
							...
							<div class="x_content">
								...
								<p>Fatores de influência na performance das vendas para o
									segundo trimestre de 2015 (mês 4 a mês 6).</p>
							</div>
						</div>
						</div>
						...
						<div class="row">
							<div class="x_panel">
								...
								<div class="x_content">
									<p>O fator de maior menção que influenciam as vendas, tanto
										positivamente como negativamente, foi o nível de atividade
										setorial, no segundo semestre de 2015. Logo em seguida, o
										fator mais mencionado foi a disponibilidade de crédito.
										Juntos, os dois fatores somam quase 80% das entrevistas. A
										classe "Motivos pontuais" que aparece em com 3,3% dos
										respondentes da pesquisa deve-se a fatores específicos como
										safra recorde, fechamento de contrato com transportadoras
										entre outros, muitas vezes condição exclusiva do respondente.
									</p>
								</div>
							</div>
						</div>
	...
	<script>
		...
		var barChartData = {
				labels : [ "Sem Resposta", "Motivos Pontuais", "Sem Alteração", "Preços", "Disponibilidade de Crédito", "Nível de Atividade Econômica Setorial"],
				datasets : [ {
