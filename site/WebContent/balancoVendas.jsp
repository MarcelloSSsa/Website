...
<body class="nav-md">
				...
				<div class="">
					<div class="page-title">
						<div class="title_left">
							<h3>
								Balanço das vendas <small></small>
							</h3>
						</div>
					...
					<div class="col-md-6 col-sm-6 col-xs-12">
						<div class="x_panel">
							<div class="x_title">
								<h2>
									Compras ano passado <small>VS ano atual</small>
								</h2>
							...
							<table> 
								...
								<td>
								<span>Qty 15</span></td>
								<td><div style="background-color: #455C73; width:17px; height: 17px;"></div></td>
								<td><span>Qty 16</span></td>
								</tr>
							</table>
								<p></p>
							</div>
						...
						<div class="x_panel">
							<div class="x_title">
								<h2>
									Variação nas vendas <small>ano corrente X ano passado</small>
								</h2>
							...
							<table> 
								...
								<div style="background-color: #26B99A; width:17px; height: 17px;"></div></td>
								<td>
								<span>Todos os frotistas</span></td>
								<td><div style="background-color: #455C73;; width:17px; height: 17px;"></div></td>
								<td><span>Marca A como marca principal</span></td>
								</tr>
							</table>
								<p></p>
							</div>
	...
	<script>
		...
		var barChartData = {
				labels : [ "0", "1 a 5", "6 a 10", "11 a 20", "+20" ],
				datasets : [ {
		...
		var barChartData2 = {
				labels : [ "-20%", "-15 a -20%", "-10 a 15%", "-5 a -10%", "0 a -5%", "Estável", "0 a 5%", "10 a 15%", "15 a 20", "+20%" ],
				datasets : [ {
					fillColor : "#26B99A", //rgba(220,220,220,0.5)
					strokeColor : "#26B99A", //rgba(220,220,220,0.8)
					highlightFill : "#36CAAB", //rgba(220,220,220,0.75)
					highlightStroke : "#36CAAB", //rgba(220,220,220,1)
					data : [ 0, 0, 0, 2, 4, 5, 12, 14, 8, 0 ]
				}, {
					fillColor : "#03586A", //rgba(151,187,205,0.5)
					strokeColor : "#03586A", //rgba(151,187,205,0.8)
					highlightFill : "#066477", //rgba(151,187,205,0.75)
					highlightStroke : "#066477", //rgba(151,187,205,1)
					data : [ 0, 0, 0, 0, 0, 1, 6, 5, 2, 0 ]
				} ],
			}
