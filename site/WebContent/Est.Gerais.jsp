				...
				<div class="">
					<div class="page-title">
						<div class="title_left">
							<h3>
								Estatísticas <small> Gerais </small>
							</h3>
						</div>
					</div>
					...
					<div class="row">
						...
						<div class="x_panel">
							<div class="x_title">
								<h2>
									Amostra Por Regiões <small>(Porcentagem)</small>
								</h2>
							...
							<div class="x_content">
								...
								<td><div style="background-color: #3498DB; width:17px; height: 17px;"></div></td>
								<td><span>Sudeste</span></td>
								</tr>
							</table>
								<h4>Distribuição das pesquisas realizadas por macro-região
									do Brasil, referente ao período do segundo semestre de 2015
									(mês 4 a mês 6).</h4>
							</div>
						</div>
						</div>
						...
						<div class="x_panel">
							<div class="x_title">
								<h2>
									Conclusões <small>Macro Regiões</small>
								</h2>

								<div class="clearfix"></div>
							</div>
							<div class="x_content">
								<h5>A região sudeste apresentou a maior concentração de
									entrevistas, seguida da região Sul, Centro-Oeste, Nordeste e
									Norte. A região sudeste apresentou o maior índice de
									entrevistas pela sua representatividade em termos
									sócio-econômicos.</h5>
							</div>
						</div>
					</div>
