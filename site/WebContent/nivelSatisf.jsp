...
<body class="nav-md">
				...
				<div class="">
					...
					<div class="col-md-6 col-sm-6 col-xs-12">
						<div class="x_panel">
							<div class="x_title">
								<h2>
									Nivel de satisfação dos <small>proprietário de frota</small>
								</h2>
                            ...
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    <table class="table table-bordered">
                                        <thead>
                                            <tr>
                                                <th>Cotas e negociação</th>
                                                <th>Respostas</th>       
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <tr>
                                                <th scope="row">Muito satisfeito</th>
                                                <td>21</td>
                                            </tr>
                                            <tr>
                                                <th scope="row">Satisfeito</th>
                                                <td>6</td>
                                            </tr>
                                            <tr>
                                                <th scope="row">Insatisfeito</th>
                                                <td>3</td>
                                            </tr>
                                            <tr>
                                                <th scope="row">Muito insatisfeito</th>
                                               	<td>0</td>
                                            </tr>
                                            <tr>
                                                <th scope="row">Não sabe, não respondeu</th>
                                               	<td>0</td>
                                            </tr>
                                        </tbody>
                                    </table> 
					...
					<div class="col-md-6 col-sm-6 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2>Considerações <small></small></h2>
                                    <div class="clearfix"></div>
                                </div>
                                <div class="x_content">
                                    <p>O nível de satisfação com o produto da marca "A" está acima da média e com uma boa vantagem na classificação, com relação ao segundo lugar.</p>
                                </div>
                            </div>
                        </div> 
                            ...
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    <p>O ítem qualidade de produto foi mencionado 20 vezes, e foi a terceira mais citada. Em primeiro lugar está a interação com a concessionária no momento da compra, foi citado 30 vezes ess quesito.</p>
                                </div>
                            </div>
                        </div>                        
					</div>
	...
	<script>
		...
		var barChartData = {
				labels : [ "Marca A (%)", "Média Geral (%)", "Segundo lugar (%)" ],
				datasets : [ {
